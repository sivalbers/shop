@props(['align' => 'right', 'width' => '56', 'contentClasses' => 'py-1 bg-white dark:bg-gray-700'])
...
<div class="relative w-full" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            style="display: none;"
            @click="open = false">
        <div class="rounded-md ring-1 ring-black ring-opacity-5 border border-gray-400 {{ $contentClasses }}">
            {{ $content }}
        </div>
    </div>
</div>
