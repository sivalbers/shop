    ...
    <div class="flex fixed top-0 bg-opacity-60 item-center w-full h-full bg-slate-100 backdrop-blur-[2px]"
        x-show="showFavoritForm" x-cloak
        x-on:click.self="showFavoritForm = false"
        x-on:keydown.escape.window="showFavoritForm = false"> <!-- gesamtes Fenster backdrop-blur-[2px] -->
