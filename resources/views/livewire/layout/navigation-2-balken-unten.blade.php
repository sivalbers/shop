        ...
        <div class="flex w-full h-24  ">
            <div class="flex-grow justify-between " ><!-- zeile oben logo - suche - zeugnisarchiv -->
                <div class="flex items-center w-full">
                    <div class="flex flex-col w-full">
                        ...
                        <div class="{{ \App\Helpers\SortimentHelper::getBGColorClass($sortiment) }} h-12 py-4 space-x-8 flex text-white justify-end ">

                            <div class="space-x-8 flex">
                                <x-nav-link
                                    :href="route('shop')"
                                    :active="request()->routeIs('shop')"
                                    wire:navigate class="{{ \App\Helpers\SortimentHelper::getTextZuBGColorClass($sortiment) }}">
                            ...
                            <div class="space-x-8 flex">
                                <x-nav-link :href="route('news')" :active="request()->routeIs('news')" wire:navigate class="{{ \App\Helpers\SortimentHelper::getTextZuBGColorClass($sortiment) }}">
                            ...
                            <div class="space-x-8 flex">
                                <x-nav-link :href="route('bestellungen')" :active="request()->routeIs('bestellungen')" wire:navigate class="{{ \App\Helpers\SortimentHelper::getTextZuBGColorClass($sortiment) }}">
            ...
            <div class="flex h-28  pb-4"> <!-- Anzahl und preis -->
                <div class="flex flex-row justify-between w-full">
                    <div class="inline-flex flex-col sm:items-center ">
                        <x-nav-link :href="route('shop', ['activeTab' => 'warenkorb'])" wire:navigate class=" h-12 px-4">
                            <x-fluentui-shopping-bag-20-o class="w-8 h-8" />
                            <div class="text-5xl text-sky-600">{{ $bestellung->anzpositionen }}</div>
                        </x-nav-link>
                        <!-- Preis-Anzeige -->
                        <div class="h-12 w-full {{ \App\Helpers\SortimentHelper::getBGColorClass($sortiment) }}">
                            <div class="text-xs
            ...
            <div class="flex flex-col h-28 ">
                ...
                <div class="h-12 w-full">
                    <x-dropdown align="right">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center pl-2 pt-2 text-sm focus:outline-none transition ease-in-out duration-150 w-full {{ \App\Helpers\SortimentHelper::getBGColorClass($sortiment) }}">
                                <div class=" text-start {{ \App\Helpers\SortimentHelper::getTextZuBGColorClass($sortiment) }}">
