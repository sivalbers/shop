<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="w-full flex flex-row ">
        ...
        <div class="w-full flex justify-between h-20 pr-2 " >
            ...
            @if (Auth::user())
                    <!-- Settings Anzahl und Zeugnisarchiv ******************************************************************************************
                         Settings Anzahl und Zeugnisarchiv ******************************************************************************************
                         Settings Anzahl und Zeugnisarchiv ******************************************************************************************
                    -->
            <div class="hidden sm:flex w-56 ">
                <div class="flex flex-row justify-between w-full">
                    <div class="flex flex-col sm:items-center sm:ms-3">

                        <x-nav-link :href="route('shop',[ 'activeTab' => 'warenkorb'] )"  wire:navigate>
